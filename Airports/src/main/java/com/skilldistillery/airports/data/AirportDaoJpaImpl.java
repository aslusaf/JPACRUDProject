...
public class AirportDaoJpaImpl implements AirportDAO {
	...
	@Override
	public void updateAirport(String name, String city, String state, int airportId) {

		Airport airportToUpdate = em.find(Airport.class, airportId);
		airportToUpdate.setAirportName(name);
		airportToUpdate.setCityName(city);
		airportToUpdate.setStateName(state);
